...
data class WraythEolEvent(
    val ignoreWhenBlank: Boolean,
) : WraythEvent

data class WraythDataReceivedEvent(
    val text: String,
) : WraythEvent

data class WraythStreamEvent(
    val id: String?,
) : WraythEvent

data class WraythClearStreamEvent(
    val id: String,
) : WraythEvent

data class WraythModeEvent(
    val id: String?,
) : WraythEvent

data class WraythAppEvent(
...
data class WraythPushStyleEvent(
    val style: WarlockStyle,
) : WraythEvent

data object WraythPopStyleEvent : WraythEvent

data class WraythPromptEvent(
    val text: String,
) : WraythEvent

data class WraythTimeEvent(
    val time: Long,
) : WraythEvent

data class WraythRoundTimeEvent(
    val time: String,
) : WraythEvent

data class WraythCastTimeEvent(
    val time: String,
) : WraythEvent

data class WraythSettingsInfoEvent(
    val crc: String?,
    val instance: String?,
) : WraythEvent
...
data class WraythRightEvent(
    val value: String,
) : WraythEvent

data class WraythSpellEvent(
    val value: String,
) : WraythEvent

data class WraythIndicatorEvent(
    val iconId: String,
    val visible: Boolean,
) : WraythEvent

data class WraythComponentStartEvent(
    val id: String,
) : WraythEvent

data object WraythComponentEndEvent : WraythEvent

data class WraythComponentDefinitionEvent(
    val id: String,
) : WraythEvent

data object WraythHandledEvent : WraythEvent

data class WraythStreamWindowEvent(
...
data class WraythCliEvent(
    val cmd: CmdDefinition,
) : WraythEvent

data class WraythPushCmdEvent(
    val cmd: WraythCmd,
) : WraythEvent

data class WraythMenuStartEvent(
    val id: Int?,
) : WraythEvent
