...
class CompiledAlteration(
    private val alteration: AlterationEntity,
) {
    val regex =
        Regex(
    ...
    fun appliesToStream(streamName: String): Boolean =
        alteration.sourceStream.isNullOrBlank() || streamName.equals(alteration.sourceStream, ignoreCase = true)
}
