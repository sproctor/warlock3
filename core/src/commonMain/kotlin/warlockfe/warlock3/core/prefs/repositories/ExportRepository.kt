        ...
        return CharacterExport(
            ...
            baseStyle =
                BaseStyleExport(
                    ...
                    panelFont = config.settings.panelFont,
                    panelScale = config.settings.panelScale,
...
private fun CharacterSettingsConfig.replaceBase(
    ...
    copy(
        ...
        panelFont = if (baseStyle != null) baseStyle.panelFont else fallback.panelFont,
        panelScale = if (baseStyle != null) baseStyle.panelScale else fallback.panelScale,
...
private fun CharacterSettingsConfig.mergeBase(baseStyle: BaseStyleExport?): CharacterSettingsConfig {
    ...
    return copy(
        ...
        panelFont = baseStyle.panelFont ?: panelFont,
        panelScale = baseStyle.panelScale ?: panelScale,
