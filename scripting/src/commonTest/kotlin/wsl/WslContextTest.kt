...
class WslContextTest {
    ...
    @Test
    fun lookupUnknownVariableReturnsNull() =
        runTest {
    ...
    @Test
    fun setAndLookupScriptVariable() =
        runTest {
    ...
    @Test
    fun localVariableShadowsScriptVariable() =
        runTest {
    ...
    @Test
    fun builtInScriptVariablesExist() =
        runTest {
    ...
    @Test
    fun getNextLineAdvancesThenReturnsNull() =
        runTest {
    ...
    @Test
    fun gosubPushesFrameWithArguments() =
        runTest {
    ...
    @Test
    fun gosubReturnAtTopLevelThrows() =
        runTest {
    ...
    @Test
    fun listenerReceivesTextEvents() =
        runTest(UnconfinedTestDispatcher()) {
