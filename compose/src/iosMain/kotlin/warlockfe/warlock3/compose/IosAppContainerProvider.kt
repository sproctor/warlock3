...
object IosAppContainerProvider {
    val appContainer: AppContainer by lazy {
        ...
        val databaseBuilder = Room.databaseBuilder<PrefsDatabase>(
            name = dbPath,
        )
    ...
    val sgeSettings: SgeSettings by lazy {
        val simuCert = runBlocking {
            warlockfe.warlock3.compose.generated.resources.Res.readBytes("files/simu.pem")
        }
        SgeSettings(
...
private class IosProxy(command: String) : WarlockProxy {
